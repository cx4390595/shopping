...
<template>
    <div>
          ...
          <div class="checkout-addr">
            ...
            <div class="addr-list-wrap">
                ...
                <ul>
                  <li v-for="(item,index) in addressListFilter" v-bind:class="{'check':checkIndex == index}" @click="checkIndex=index;selectedAddrId=item.addressId">
                    ...
                    <div class="addr-opration addr-del">
                      <a href="javascript:;" class="addr-del-btn" @click="delAddressConfirm(item.addressId)"><!--@click="delAddressConfirm(item.addressId)"-->
              ...
              <div class="shipping-addr-more">
                <a class="addr-more-btn up-down-btn" @click="expand" v-bind:class="{'open':limit>3}" href="javascript:;"  >
                  more
                  <i class="i-up-down">
      ...
      <Modal :mdShow="isMdShow2" @close="isMdShow2 = false">
        <p slot="message">地址列表至少要有一条数据,已经无法继续删除</p>
        <div slot="btnGroup">
